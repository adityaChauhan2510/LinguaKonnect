  ...
  return (
    <div>
      <div className="flex flex-1 flex-col">
        <div className="flex flex-1 flex-col md:flex-row items-center justify-center md:m-[60px] m-15">
            ...
            <div className="grid grid-cols-12">
              <div className="md:col-span-8 col-span-12">
                <div className="flex items-center justify-center p-1.5 sm:p-4 lg:p-6">
                  <div className="relative w-full md:px-2 sm:px-10 px-2">
              ...
              <div className="md:col-span-4 col-span-2">
                <div className="flex flex-1 flex-col items-center justify-center lg:m-6 md:mt-9 lg:mt-14 xl:mt-20 mt-3">
      ...
      <div className="mt-[10px] mx-15 md:mx-[60px] flex-grow flex flex-col h-[20rem]">
